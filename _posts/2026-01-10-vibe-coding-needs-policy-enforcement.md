...
{% include blog-image.html file="problem_1.png" alt="skipping steps" %}
...
{% include blog-image.html file="problem_2.png" alt="ignoring conventions" %}
...
{% include blog-image.html file="problem_3.png" alt="making wrong assumptions" class="long-image" %}
...
{% include blog-image.html file="problem_4.png" alt="local optimization" class="long-image" %}
